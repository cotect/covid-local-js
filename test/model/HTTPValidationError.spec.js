...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Covid19LocalApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instane = new Covid19LocalApi.HTTPValidationError();
      //expect(instance).to.be.a(Covid19LocalApi.HTTPValidationError);
    });
